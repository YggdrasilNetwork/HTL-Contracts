import { CadenceArgument } from "@onflow/sdk/types/interaction/interaction";
 ...
 */
export declare function args(ax: CadenceArgument<any>[]): (x: import("@onflow/typedefs").Interaction) => Promise<import("@onflow/typedefs").Interaction>;
/**
 ...
 */
export declare function arg<T extends TypeDescriptor<any, any>>(value: TypeDescriptorInput<T>, xform: T): CadenceArgument<T>;

...
export interface StreamConnection<ChannelMap extends {
    [name: string]: any;
}> {
    on<C extends keyof ChannelMap>(channel: C, listener: (data: ChannelMap[C]) => void): this;
    on(event: "close", listener: () => void): this;
    on(event: "error", listener: (err: any) => void): this;
    off<C extends keyof ChannelMap>(event: C, listener: (data: ChannelMap[C]) => void): this;
...
export * from "@onflow/typedefs/types/interaction";

import { Numeric } from ".";
import { FlushResponse, IncreaseTimeResponse, LoadL1MessagingContractResponse, SetTimeResponse, PredeployedAccount, L1ToL2MockTxResponse, L2ToL1MockTxResponse, NewBlockResponse } from "../devnet-utils";
...
export interface Devnet {
     ...
     */
    sendMessageToL2: (l2ContractAddress: string, functionName: string, l1ContractAddress: string, payload: Array<Numeric>, nonce: Numeric, paidFeeOnL1: Numeric) => Promise<L1ToL2MockTxResponse>;
    /**
     ...
     */
    consumeMessageFromL2: (l2ContractAddress: string, l1ContractAddress: string, payload: Array<Numeric>) => Promise<L2ToL1MockTxResponse>;
    /**

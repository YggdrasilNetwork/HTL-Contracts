...
function connectWc(WalletConnectModal) {
  return async _ref4 => {
    ...
    invariant(!!client.opts?.projectId, "Cannot establish connection, WalletConnect projectId is undefined");
    ...
    try {
      ...
      invariant(!!uri, "Cannot establish connection, WalletConnect URI is undefined");
      if (isMobile()) {
...
export { SERVICE_PLUGIN_NAME, init, initLazy };
//# sourceMappingURL=fcl-wc.module.mjs.map
